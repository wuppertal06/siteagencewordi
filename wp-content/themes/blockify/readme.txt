...
* Add: Add aria-label setting for buttons when no text is present
* Add: Render preview for archive title block when in editor
* Fix: Icon svg size and border radius
* Fix: Marquee block gap
* Fix: Archive title color for blog page
* Fix: Formatting empty custom properties
* Fix: Remove unused role from newsletter form
* Fix: Remove aria-hidden from duplicated marquee items

= 1.4.9 - 29 April 2024 =

* Fix: Inline SVG dom warning
* Fix: Animations repeating on window resize
* Update: Dark mode improvements
* Update: Refactor composer packages

= 1.4.8 - 19 April 2024 =

* Add: New `blockify_dark_mode` filter

= 1.4.7 - 19 April 2024 =

* Add: Block gap support to Group block
* Add: On-click support to Cover block
* Add: CSS Filter support to Button block
* Add: Filter hover state setting
* Add: Dynamic header height spacer
* Add: Additional styles block setting
* Add: Circle icon details block style
* Add: Newsletter placeholder block variation
* Add: Onclick support to svg block variation
* Add: Justify-space-between support to button block
* Add: Inline svg support to buttons
* Add: Social link padding custom property
* Fix: Dark mode in site editor
* Fix: Editor script loading hook
* Fix: Social links color check error
* Fix: Search block background color classes
* Fix: Icon block animations
* Fix: Navigation sub menu alignment
* Update: Only load parent template patterns for child themes
* Update: Typography scale min font sizes

= 1.4.6 - 5 April 2024 =

* Add: Button transform support
* Add: Scale animations
* Add: Larger font sizes
* Fix: Video background poster
* Fix: Navigation submenu background color
* Update: Composer packages (format custom property method)

= 1.4.5 - 22 March 2024 =

* Add: Re-add parent patterns
* Fix: Empty pattern content

= 1.4.4 - 21 March 2024 =

* Fix: Windows path errors
* Fix: Use wp_enqueue_block_styles when in editor (Windows fix)
* Remove: Parent patterns

= 1.4.3 - 15 March 2024 =

* Fix: String warning in Windows

= 1.4.2 - 12 March 2024 =

* Fix: Template HTML string check

= 1.4.1 - 12 March 2024 =

* Remove: Dark style variation
* Update: Languages POT file

= 1.4.0 - 12 March 2024 =

* Add: 22 new style variations
* Add: SVG sanitizer for svg output
* Add: Plugin integration support
* Add: SVG avatars (replaced jpg)
* Add: Dynamic color palette and gradient patterns
* Add: Support for feature image hover styles
* Add: Template tags
* Add: Fade CSS utility classes
* Add: Fade Edges setting to marquee variation
* Update: Refactored to use composer packages
* Update: Node packages
* Update: Dark mode improvements (media query, custom properties)
* Update: Grid column improvements
* Update: CSS utility class improvements (nowrap, flex, etc)
* Update: Restricted SVG and On-Click settings to admin users
* Update: Replace anchor elements with button elements when no URL for a11y
* Fix: Icon color handling
* Fix: Columns block error
* Fix: Gradient text format for updated WP package versions
* Fix: Navigation menu color handling
* Fix: Placeholder image display in editor
* Fix: Alignwide widths
* Fix: Post excerpt handling and improvements
* Fix: White and black custom property overrides
* Fix: Block patterns filter hook
* Remove: Placeholder avatar jpgs
